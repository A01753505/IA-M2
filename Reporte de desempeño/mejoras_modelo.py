...
from sklearn.metrics import classification_report, accuracy_score, precision_score, recall_score, f1_score #type: ignore
...
# Clasificación
grid_search = GridSearchCV(tree, param_grid, cv=6, scoring='accuracy')  # accuracy - maximizar la cantidad de predicciones correctas
